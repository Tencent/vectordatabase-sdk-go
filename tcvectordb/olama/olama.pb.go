...
var file_olama_proto_rawDesc = []byte{
	...
	0x6e, 0x22, 0x88, 0x02, 0x0a, 0x0f, 0x41, 0x64, 0x64, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73,
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73,
	0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f,
	...
	0x63, 0x74, 0x2a, 0x73, 0x0a, 0x0e, 0x53, 0x68, 0x61, 0x72, 0x64, 0x44, 0x61, 0x74, 0x61, 0x53,
	...
	0x5f, 0x53, 0x54, 0x52, 0x49, 0x4e, 0x47, 0x10, 0x00, 0x32, 0xd9, 0x0a, 0x0a, 0x0c, 0x53, 0x65,
	...
	,
...
var file_olama_proto_msgTypes = make([]protoimpl.MessageInfo, 71)
var file_olama_proto_goTypes = []interface{}{
	...
	(*AddIndexRequest)(nil),            // 67: olama.AddIndexRequest
	(*AddIndexResponse)(nil),           // 68: olama.AddIndexResponse
	nil,                                // 69: olama.Document.FieldsEntry
	(*Field_StringArray)(nil),          // 70: olama.Field.StringArray
	nil,                                // 71: olama.CollectionConf.FieldMetasEntry
	nil,                                // 72: olama.CollectionConf.OptionsEntry
	nil,                                // 73: olama.CreateCollectionRequest.IndexesEntry
	nil,                                // 74: olama.RerankParams.WeightsEntry
	nil,                                // 75: olama.DatabaseResponse.InfoEntry
	nil,                                // 76: olama.AddIndexRequest.IndexesEntry
}
var file_olama_proto_depIdxs = []int32{
	69, // 0: olama.Document.fields:type_name -> olama.Document.FieldsEntry
	8,  // 1: olama.Document.sparse_vector:type_name -> olama.SparseVecItem
	70, // 2: olama.Field.val_str_arr:type_name -> olama.Field.StringArray
	...
	71, // 8: olama.CollectionConf.field_metas:type_name -> olama.CollectionConf.FieldMetasEntry
	72, // 9: olama.CollectionConf.options:type_name -> olama.CollectionConf.OptionsEntry
	...
	73, // 27: olama.CreateCollectionRequest.indexes:type_name -> olama.CreateCollectionRequest.IndexesEntry
	...
	74, // 45: olama.RerankParams.weights:type_name -> olama.RerankParams.WeightsEntry
	...
	75, // 55: olama.DatabaseResponse.info:type_name -> olama.DatabaseResponse.InfoEntry
	76, // 56: olama.AddIndexRequest.indexes:type_name -> olama.AddIndexRequest.IndexesEntry
	7,  // 57: olama.Document.FieldsEntry.value:type_name -> olama.Field
	15, // 58: olama.CollectionConf.FieldMetasEntry.value:type_name -> olama.FieldMeta
	30, // 59: olama.CreateCollectionRequest.IndexesEntry.value:type_name -> olama.IndexColumn
	12, // 60: olama.DatabaseResponse.InfoEntry.value:type_name -> olama.DatabaseItem
	30, // 61: olama.AddIndexRequest.IndexesEntry.value:type_name -> olama.IndexColumn
	20, // 62: olama.SearchEngine.setAlias:input_type -> olama.AddAliasRequest
	23, // 63: olama.SearchEngine.getAlias:input_type -> olama.GetAliasRequest
	21, // 64: olama.SearchEngine.deleteAlias:input_type -> olama.RemoveAliasRequest
	33, // 65: olama.SearchEngine.createCollection:input_type -> olama.CreateCollectionRequest
	35, // 66: olama.SearchEngine.dropCollection:input_type -> olama.DropCollectionRequest
	37, // 67: olama.SearchEngine.truncateCollection:input_type -> olama.TruncateCollectionRequest
	25, // 68: olama.SearchEngine.describeCollection:input_type -> olama.DescribeCollectionRequest
	27, // 69: olama.SearchEngine.listCollections:input_type -> olama.ListCollectionsRequest
	39, // 70: olama.SearchEngine.rebuildIndex:input_type -> olama.RebuildIndexRequest
	41, // 71: olama.SearchEngine.upsert:input_type -> olama.UpsertRequest
	44, // 72: olama.SearchEngine.update:input_type -> olama.UpdateRequest
	49, // 73: olama.SearchEngine.query:input_type -> olama.QueryRequest
	59, // 74: olama.SearchEngine.search:input_type -> olama.SearchRequest
	59, // 75: olama.SearchEngine.hybrid_search:input_type -> olama.SearchRequest
	46, // 76: olama.SearchEngine.dele:input_type -> olama.DeleteRequest
	63, // 77: olama.SearchEngine.createDatabase:input_type -> olama.DatabaseRequest
	63, // 78: olama.SearchEngine.dropDatabase:input_type -> olama.DatabaseRequest
	63, // 79: olama.SearchEngine.listDatabases:input_type -> olama.DatabaseRequest
	65, // 80: olama.SearchEngine.get_version:input_type -> olama.GetVersionRequest
	67, // 81: olama.SearchEngine.addIndex:input_type -> olama.AddIndexRequest
	22, // 82: olama.SearchEngine.setAlias:output_type -> olama.UpdateAliasResponse
	24, // 83: olama.SearchEngine.getAlias:output_type -> olama.GetAliasResponse
	22, // 84: olama.SearchEngine.deleteAlias:output_type -> olama.UpdateAliasResponse
	34, // 85: olama.SearchEngine.createCollection:output_type -> olama.CreateCollectionResponse
	36, // 86: olama.SearchEngine.dropCollection:output_type -> olama.DropCollectionResponse
	38, // 87: olama.SearchEngine.truncateCollection:output_type -> olama.TruncateCollectionResponse
	26, // 88: olama.SearchEngine.describeCollection:output_type -> olama.DescribeCollectionResponse
	28, // 89: olama.SearchEngine.listCollections:output_type -> olama.ListCollectionsResponse
	40, // 90: olama.SearchEngine.rebuildIndex:output_type -> olama.RebuildIndexResponse
	43, // 91: olama.SearchEngine.upsert:output_type -> olama.UpsertResponse
	45, // 92: olama.SearchEngine.update:output_type -> olama.UpdateResponse
	50, // 93: olama.SearchEngine.query:output_type -> olama.QueryResponse
	62, // 94: olama.SearchEngine.search:output_type -> olama.SearchResponse
	62, // 95: olama.SearchEngine.hybrid_search:output_type -> olama.SearchResponse
	47, // 96: olama.SearchEngine.dele:output_type -> olama.DeleteResponse
	64, // 97: olama.SearchEngine.createDatabase:output_type -> olama.DatabaseResponse
	...
	66, // 100: olama.SearchEngine.get_version:output_type -> olama.GetVersionResponse
	68, // 101: olama.SearchEngine.addIndex:output_type -> olama.AddIndexResponse
