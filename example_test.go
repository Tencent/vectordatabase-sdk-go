	...
	_, err := col.Upsert(context.Background(), []model.Document{
		{
			...
			Fields: map[string]model.Field{
				"bookName": model.Field{Val: "西游记"},
				"author":   model.Field{Val: "吴承恩"},
				"page":     model.Field{Val: 21},
				"segment":  model.Field{Val: "富贵功名，前缘分定，为人切莫欺心。"},
			},
		},
		{
			Id:     "0002",
			...
			Fields: map[string]model.Field{
				...
				"segment":  model.Field{Val: "正大光明，忠良善果弥深。些些狂妄天加谴，眼前不遇待时临。"},
			},
		},
		{
			Id:     "0003",
			...
			Fields: map[string]model.Field{
				"bookName": model.Field{Val: "三国演义"},
				"author":   model.Field{Val: "罗贯中"},
				"page":     model.Field{Val: 23},
				"segment":  model.Field{Val: "细作探知这个消息，飞报吕布。"},
			},
		},
		{
			Id:     "0004",
			...
			Fields: map[string]model.Field{
				"bookName": model.Field{Val: "三国演义"},
				"author":   model.Field{Val: "罗贯中"},
				"page":     model.Field{Val: 24},
				"segment":  model.Field{Val: "布大惊，与陈宫商议。宫曰：“闻刘玄德新领徐州，可往投之。”布从其言，竟投徐州来。有人报知玄德。"},
			},
		},
		{
			Id:     "0005",
			...
			Fields: map[string]model.Field{
				"bookName": model.Field{Val: "三国演义"},
				"author":   model.Field{Val: "罗贯中"},
				"page":     model.Field{Val: 25},
				"segment":  model.Field{Val: "玄德曰：“布乃当今英勇之士，可出迎之。”糜竺曰：“吕布乃虎狼之徒，不可收留；收则伤人矣。"},
			},
		},
